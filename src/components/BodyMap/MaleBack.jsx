...
const MaleBack = ({ className, recentMuscles = [], oldMuscles = [], ...props }) => {
    ...
    const hoverColor = "#84cc16";   // Color para hover
    ...
    return (
        ...
        >
            ...
            >
                ...
                <path d="M630.78 645.19s-8.31-5.16-2.87-13.06c4.55-6.58 5.28-6.14 2.87-15.29-1.87-7.08-.7-12.38-3.36-17.5M228.95 211.29c1.57-.7 9.71-6.15 14.7-8.41s25.39-10.44 30.52-12.98c5.14-2.54 14.41-11.57 14.41-11.57l.25-3.16c.72-7.78 1.02-39.35 1.02-39.35-2.91-5.76-3.49-15.57-3.49-15.57-7.29 1.44-12.53-1.87-13.99-21.04-.83-10.94 2.52-14.45 5.55-15.44M382.62 83.78c3.02 1 6.37 4.51 5.54 15.44-1.46 19.17-6.71 22.48-13.99 21.04 0 0-.58 9.81-3.5 15.57 0 0 .29 31.57 1.03 39.35l.24 3.16s9.27 9.03 14.41 11.57c5.14 2.54 25.54 10.73 30.53 12.98s13.13 7.71 14.69 8.41" />
                <path d="M330.26 131.3c15.78 0 25.12 12.03 29.48 9.51 4.35-2.51 8.07-13.01 16.41-23.77s-.36-12.56 9.08-42.7c9.43-30.14-14.51-56.46-20.68-60.41-6.17-3.95 17.41 10.04 4.72-3.23-12.7-13.27-38.46-4.3-46.44-2.15s27.21-9.69 0-6.1c-22.12 2.92-39.92 14.6-46.79 34.66" />
                <path d="M330.26 131.3c-15.79 0-25.13 12.03-29.48 9.51-4.36-2.51-8.08-13.01-16.42-23.77s.36-12.56-9.07-42.7c-1.49-4.74-2.14-17.9-2.17-22.01v-.04a39.082 39.082 0 0 1 2.93-15.18" />
            </g>
        </svg>
    )
}
