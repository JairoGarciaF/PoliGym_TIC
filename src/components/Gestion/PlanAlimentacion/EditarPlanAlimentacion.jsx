...
export const EditarPlanAlimentacion = ({ mealPlan, onBack }) => {
  ...
  const [imagenPlanAlimentacion, setImagenPlanAlimentacion] = useState(
    mealPlan?.imagenPlanAlimentacion || null
  );
  ...
  const [categoria, setCategoria] = useState(
    mealPlan?.categoria || "Pérdida de Peso"
  );
        ...
        <Grid container spacing={2} className="pt-2">
          {Object.keys(detalleDias).map((day) => (
            <Grid item size={12} key={day}>
              <h3 className="text-azul-marino-500 sm:text-base text-sm pb-1">
              ...
              <Grid container spacing={2} columns={{ xs: 1, sm: 2, md: 3 }}>
                <Grid item size={1}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleDayChange(day, "desayuno", e.target.value)
                    }
                    fullWidth
                ...
                <Grid item size={1}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleDayChange(day, "almuerzo", e.target.value)
                    }
                    fullWidth
                    inputProps={{ maxLength: 100 }}
                    size="small"
                ...
                <Grid item size={1}>
                  <TextField
                    ...
                    onChange={(e) =>
                      handleDayChange(day, "cena", e.target.value)
                    }
                    fullWidth
                    inputProps={{ maxLength: 100 }}
                    size="small"
