...
export const EditarRutina = ({ routine, onBack }) => {
    const [nombre, setNombre] = useState(routine?.nombre || '');
    const [imagenRutina, setImagenRutina] = useState(routine.imagenRutina || null);
    const [dificultad, setDificultad] = useState(routine?.dificultad || '');
    const [ejercicios, setEjercicios] = useState(routine?.ejercicios || []);
