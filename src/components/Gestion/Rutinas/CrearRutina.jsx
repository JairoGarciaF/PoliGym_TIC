...
import { createRoutine } from "../../../services/routine/routine";
...
export const CrearRutina = ({ onBack, refreshData }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await createRoutine(workout);
      setLoading(false);
      Swal.fire({
        title: "Rutina creada",
        text: "La rutina se ha creado correctamente.",
        icon: "success",
        confirmButtonText: "Aceptar",
        confirmButtonColor: "#16243e",
      }).then(() => {
      ...
      Swal.fire({
        title: "Error",
        text: "Ha ocurrido un error al crear la rutina, por favor intente de nuevo.",
        icon: "error",
        confirmButtonText: "Aceptar",
        confirmButtonColor: "#16243e",
      });
  ...
  return (
    <form
      ...
      <h2 className="text-base font-semibold montserrat-alternates sm:text-lg  text-azul-marino-500 ">
        Crear Rutina
      </h2>
